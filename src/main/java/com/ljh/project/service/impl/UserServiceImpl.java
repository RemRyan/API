...
import static com.ljh.project.constant.UserConstant.ADMIN_ROLE;
import static com.ljh.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "ljh";

    /**
     * 凭证加密
     */
    private static final String CREDENTIALS = "Sherlock";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = DigestUtils.md5DigestAsHex((SALT + CREDENTIALS + Arrays.toString(RandomUtil.randomBytes(10))).getBytes());
     ...
     */
    @Override
    public UserVO updateCredentials(User loginUser) {
        String accessKey = DigestUtils.md5DigestAsHex((SALT + CREDENTIALS + Arrays.toString(RandomUtil.randomBytes(10))).getBytes());
        String secretKey = DigestUtils.md5DigestAsHex((SALT + CREDENTIALS + Arrays.toString(RandomUtil.randomBytes(10))).getBytes());
