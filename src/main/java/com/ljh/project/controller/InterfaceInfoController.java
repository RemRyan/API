...
import com.ljh.project.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.ljh.apiclientsdk.model.User user = new com.ljh.apiclientsdk.model.User();
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        com.ljh.apiclientsdk.model.User user = gson.fromJson(userRequestParams, com.ljh.apiclientsdk.model.User.class);
